...
\label{subsec:roc_curves}
The following figures report the ROC comparisons produced in Part II, first for the maximum-likelihood logistic models and then after adding the ridge classifier.

\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{../output/part2/roc/roc_curves.png}
\caption{ROC curves for the full logistic model, the significance-based reduced models, and the stepwise AIC model.}
\label{fig:roc_curves_base}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{../output/part2/roc/roc_curves_with_ridge.png}
\caption{ROC curves after adding the ridge logistic classifier to the previous comparison.}
\label{fig:roc_curves_with_ridge}
\end{figure}

\subsection{One-versus-Rest ROC Curves (Multinomial)}
\label{subsec:roc_ovr}

\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{../output/part3/roc/roc_one_vs_rest.png}
\caption{One-versus-rest ROC curves for the five-class multinomial logistic model. Each curve evaluates the discrimination of one genre against the pooled remaining four genres.}
\label{fig:roc_ovr}
\end{figure}
